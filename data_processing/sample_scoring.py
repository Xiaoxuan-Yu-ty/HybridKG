...
def main():
    ...
    # File paths
    parser.add_argument("--data", type=str, default="../data/ADNI/cleaned_gene_expression_data.csv", 
    ...
    # Method choice
    parser.add_argument("--method", type=str, default='ecdf',
                        choices=['ecdf', 'std', 'logfc', 'all'], 
                        help="Search method to use")
    
    # Parameters
    parser.add_argument("--threshold", type=float, default=1, help="Threshold value")
    parser.add_argument("--control", default=0, 
                        help="Control group label")
    parser.add_argument("--output_dir", type=str, default="../data/ADNI/old_target", 
    ...
    for threshold in [1,1.5,2.5,5,10,20]:
        output = os.path.join(args.output_dir,f'ecdf_{threshold}')
        process_and_save(
            data=data,
            design=design,
            threshold=threshold,
