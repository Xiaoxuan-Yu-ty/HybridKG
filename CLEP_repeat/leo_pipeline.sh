...
cd "/home/xyu/thesis/HybridKG/CLEP_repeat/"
...
for model in "${KGE_MODEL[@]}"; do
    echo "Running model: $model"
    # Use $model to pass the variable value to the script
    /home/xyu/.conda/envs/firegnn/bin/python pipeline.py --kge_hpo --kge_model "$model"
done
